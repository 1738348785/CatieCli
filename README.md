...
<details>
<summary><strong>📖 Render 部署详细步骤</strong>（点击展开）</summary>

#### 1️⃣ 点击上方按钮，登录 Render
...
Render 会自动生成一个 `.onrender.com` 域名，点击访问即可！

> 💡 免费实例会在无活动后休眠，首次访问需要 30 秒左右唤醒
...
1. 如果用 IP+端口 访问，添加端口映射 `5001:5001` 并开放防火墙
